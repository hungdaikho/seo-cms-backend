...
export class DomainOverviewDto {
    ...
    @ApiPropertyOptional({ description: 'Include subdomains in analysis', example: false })
    @IsBoolean()
    @IsOptional()
...
export class DomainTopKeywordsDto {
    ...
    @ApiPropertyOptional({ description: 'Number of keywords to return', example: 100 })
    @IsNumber()
    @IsOptional()
    @Min(1)
    @Max(500)
...
export class DomainTopicsDto {
    ...
    @ApiPropertyOptional({ description: 'Number of topics to return', example: 50 })
    @IsNumber()
    @IsOptional()
    @Min(1)
    @Max(200)
